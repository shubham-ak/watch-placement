...
export function init() {
    ...
    axesHelperSphere = new THREE.AxesHelper( 10 );
    ...
    clipPlanes = [
        new THREE.Plane(new THREE.Vector3(0, 0, 1), 0.7)
    ]
            ...
            for ( let i = 0; i < intersects.length; i ++ ) {
                ...
                if (object.object.name == 'plane') {
                    ...
                    if (watchLoaded) {
                        ...
                        axesHelperSphere.position.set(watchPosition.x , watchPosition.y , watchPosition.z);
...
export function updateLandmarkPoints(newLandmarkPoints) {
    ...
    if (landmarkPoints.length > 0) {
       ...
       // console.log("landmark2" , landmarkPoints[2]);
        ...
        axesHelperSphere.applyQuaternion(quaternion_z);
        ...
        // axesHelperSphere.applyQuaternion(quaternion_x);
